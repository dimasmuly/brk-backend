                ...
                <div class="col-12">
                    <div class="row gy-4">
                        <div class="col-md-4">
                            ...
                            <p><i class="fa fa-envelope-open text-primary me-2"></i>dreamteam4workshop@gmail.com</p>
                        </div>
                        <div class="col-md-4">
    ...
    <div class="container-xxl pt-5 pb-3">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Barista Terbaik Kami</h1>
            </div>
            <div class="row g-4">
